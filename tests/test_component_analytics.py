...
class ComponentAnalyticsTests(unittest.TestCase):
    ...
    def test_manufacturer_requires_report_wording_or_reported_brand(self) -> None:
        ...
        # The public snapshot intentionally ships no organization-specific
        # reviewed alias registry. Unreviewed names must therefore remain
        # distinct instead of being silently merged.
        self.assertEqual(canonical_manufacturer("金宇宙"), "金宇宙")
        self.assertEqual(
            canonical_manufacturer("JYZ 金宇宙能源有限公司"),
            "JYZ 金宇宙能源有限公司",
        )
        self.assertEqual(
            canonical_manufacturer("金宇宙的30mAh软包电池"),
            "金宇宙的30mAh软包电池",
        )
        self.assertEqual(
        ...
        self.assertEqual(canonical_manufacturer("敏芯微"), "敏芯微")
        self.assertFalse(manufacturer_is_rejected("用于语音通话功能拾音"))
        self.assertEqual(
            canonical_manufacturer("用于语音通话功能拾音"),
            "用于语音通话功能拾音",
        )
        self.assertEqual(
