    ...
    checks = [
        {
            ...
            "detail": "PORTFOLIO_DATABASE_URL must point to PostgreSQL",
        },
        {
            "name": "minio_backend",
        ...
        },
        {
            ...
            "passed": all(
                ...
                for name in ("OBJECT_STORAGE_ENDPOINT", "OBJECT_STORAGE_ACCESS_KEY", "OBJECT_STORAGE_SECRET_KEY", "OBJECT_STORAGE_BUCKET")
            ),
